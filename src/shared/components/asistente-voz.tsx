  ...
  return (
    <>
      ...
      <button onClick={() => setOpen(!open)} title="Asistente"
        style={{
          position: 'fixed', top: 210, left: '50%', transform: 'translateX(-50%)', width: 56, height: 56, borderRadius: '50%',
      ...
      {open && (
        <div style={{
          position: 'fixed', top: 274, left: '50%', transform: 'translateX(-50%)', width: 340, maxWidth: 'calc(100vw - 48px)',
