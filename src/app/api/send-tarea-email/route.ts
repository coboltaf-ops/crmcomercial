    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 10px 10px">
          ...
          <p style="font-size:12px;color:#9ca3af;margin:0">Ingrese al CRM Comercial para gestionar esta tarea.</p>
        </div>
        <p style="text-align:center;color:#9ca3af;font-size:11px;margin-top:16px">CRM Comercial - Gestion de Tareas</p>
      </div>`
