...
const TARJETAS_OPERATIVAS: Tarjeta[] = [
  {
    ...
    notas: [
      'Decisión estratégica — Dos CRM, dos negocios: Tras un análisis detallado junto al Ing. José E. Palomares, se decidió operar con DOS sistemas independientes: este CRM para los NEGOCIOS COMERCIALES NORTON, y un segundo CRM para los negocios de GRUPO GTM / TAMOIN (obras, ofertas y licitaciones). Beneficios en todos los aspectos: (1) datos 100% aislados y confidenciales — la información de un negocio nunca se mezcla con la del otro; (2) cada sistema con su propia base de datos, respaldos y accesos, de modo que un incidente en uno no afecta al otro; (3) cada CRM con su identidad, módulos y enfoque propios (Norton = comercial; GTM = obras/APU); (4) ambos multipaís y bilingües (ES/EN), escalables y mantenidos por separado sin riesgo cruzado; (5) total claridad operativa: cada equipo trabaja en su sistema, sin ruido del otro.',
