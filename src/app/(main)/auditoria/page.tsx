            ...
            {registros.map((r, i) => (
              <tr key={r.id} style={{ background: i % 2 === 0 ? '#f8fafc' : '#fff' }}>
                ...
                <td style={{ padding: '8px 12px', borderBottom: '1px solid #e2e8f0' }}>
                  <div className="accion-badge" style={{ display: 'inline-block', background: accColor(r.accion), color: '#ffffff', padding: '2px 10px', borderRadius: 10, fontSize: 11, fontWeight: 700 }}>{r.accion}</div>
                </td>
